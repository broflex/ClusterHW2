...
public class ClientEuclideanTsp extends Client<List<Integer>> implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4935452087641352656L;

	public ClientEuclideanTsp(String title, String domainName)
			throws RemoteException, NotBoundException, MalformedURLException {
		super(title, domainName);
	}
	...
	public ClientEuclideanTsp() throws RemoteException, MalformedURLException,
			NotBoundException {
		super("Euclidean TSP", "localhost");
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Displaying results
			client.begin();
			client.add(getLabel(minPath.toArray(new Integer[0])));
			client.end();
			space.exit();
	...
	public static JLabel getLabel(final Integer[] tour) {
	...
	private static String tourToString(Integer[] cities) {
